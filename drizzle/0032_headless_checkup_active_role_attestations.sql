...
CREATE TABLE `headless_checkup_active_role_attestations` (
    ...
    `operation_id` text NOT NULL CHECK (`operation_id` = 'mediflow.patient.checkup.status.transition.v1'),
    ...
    `revoked_at` integer, `created_at` integer NOT NULL DEFAULT (unixepoch()),

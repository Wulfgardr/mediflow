...
- `docs/treatment-reasoning-athena-shadow.md`: setup for vLLM + ToolUniverse.
...
- Codex controller: contract, validator, local verification and PR evidence.
...
Promotion rule: advisor lanes produce evidence, not authority. Codex verifies

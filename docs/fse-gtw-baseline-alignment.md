...
| Provisioning certificati: profili, create/download/renew/revoke/recover | `doc/provisioning/api-rest-provisioning.md` (private) + `doc/provisioning/openapi.yaml` | `Missing` | `High` | `WUL-41` | Nessun client provisioning o lifecycle certificati nel repo. |

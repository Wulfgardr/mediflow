...
## 2026-04-02 Codex
- Opened `WUL-131` as a documentation/governance thin slice by recording ADR 0032 for the split between canonical `synthetic-only` document corpora in repo and a private local shadow-evaluation vault, plus an operational note for future multi-archetype case packaging and the minimal plan/index updates needed to keep that decision discoverable: `docs/adr/0032-document-intelligence-corpus-and-private-shadow-vault.md`, `docs/document-intelligence-lab.md`, `PLANS.md`, `docs/README.md`, `docs/markdown-index.md`

...
| [docs/analysis/2026-06-01-agentic-parliament-run.md](./analysis/2026-06-01-agentic-parliament-run.md) | Digest interno della prima run Parlamento agentico, con ruoli, decisioni e proposte operative. | Quando serve ricostruire la prima validazione del processo WUL-295 senza riaprire transcript esterni. |
| [docs/analysis/2026-06-01-agentic-parliament-repoprompt-export.md](./analysis/2026-06-01-agentic-parliament-repoprompt-export.md) | Export/digest RepoPrompt della run Parlamento agentico. | Quando serve l'evidenza di contesto usata per il confronto multi-agent. |
| [docs/analysis/2026-06-01-agentic-dynamics-test-run.md](./analysis/2026-06-01-agentic-dynamics-test-run.md) | Digest interno del test della dinamica agentica Codex/Claude/Gemini. | Quando si rivede la meccanica di tesi, cross-exam e decisione Codex prima di nuove deleghe. |

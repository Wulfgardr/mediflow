...
| [docs/siss-prescription-live-process-map.md](./siss-prescription-live-process-map.md) | Mappa public-safe del percorso live osservato nella webapp prescrittiva SISS: stati, catalogo specialistica, validazioni, registrazione e PDF senza identificativi reali o session material. | Quando serve una mappa di processo del prescrittivo osservato senza usare l'evidence pack privato. |

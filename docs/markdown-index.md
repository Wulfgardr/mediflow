...
| [docs/adr/0078-lume-lingua-di-design-di-destinazione.md](./adr/0078-lume-lingua-di-design-di-destinazione.md) | Adotta Lume come lingua di design di destinazione multipiattaforma (modello focale, filo, due voci), con Vetro Clinico come canone transitorio e migrazione L0-L6; ADR 0047 invariato. |

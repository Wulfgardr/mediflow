...
| [docs/design/vetro-clinico/README.md](./design/vetro-clinico/README.md) | Ingresso del sistema di design Vetro Clinico: glossario dei nomi (Vetro Clinico/Liquid Glass/Kree8), ordine di lettura, regole redazionali, precedenza. | Prima di qualsiasi lavoro visivo o di interazione su MediFlow, su ogni piattaforma. |
| [docs/design/vetro-clinico/01-fondamenta.md](./design/vetro-clinico/01-fondamenta.md) | Principi del design MediFlow, audit onesto dello stato attuale (web + nativo) e decisioni vincolanti (ADR 0047/0060, direzione unica, Referto respinto). | Quando si prende una decisione di design o serve capire cosa è canone e cosa è debito. |
| [docs/design/vetro-clinico/02-token.md](./design/vetro-clinico/02-token.md) | Architettura token a tre livelli (DTCG come sorgente), palette semantica consolidata, tipografia clinica, geometria concentrica, motion token, azioni di consolidamento. | Quando si aggiunge o cambia colore, corpo testo, raggio, ombra, blur o durata in UI. |
| [docs/design/vetro-clinico/03-materiali.md](./design/vetro-clinico/03-materiali.md) | Sistema dei materiali: vetro strutturale, carta clinica, vetro transitorio, leggi di sovrapposizione, leggibilità sul vetro, dark, degrado controllato. | Quando si decide il trattamento di superficie di una regione UI o si tocca backdrop-filter/materiali. |
| [docs/design/vetro-clinico/04-interazione.md](./design/vetro-clinico/04-interazione.md) | Grammatica di interazione: feedback al pointer-down, spring, continuità Quadro/Scheda, tastiera, form clinici, stati onesti. | Quando si progetta o rivede un comportamento interattivo. |
| [docs/design/vetro-clinico/05-responsivita.md](./design/vetro-clinico/05-responsivita.md) | Ruoli dei breakpoint, modello a due densità, touch vs puntatore, finestre e multitasking. | Quando si lavora sul comportamento del layout tra dimensioni o si valuta la preferenza densità. |
| [docs/design/vetro-clinico/06-accessibilita.md](./design/vetro-clinico/06-accessibilita.md) | Contratto WCAG 2.2 AA, caso peggiore del vetro, gap nativi Apple, matrice di verifica. | Quando si rivede l'accessibilità di una superficie o si spedisce UI con traslucenza o motion. |
| [docs/design/vetro-clinico/07-piattaforme/web.md](./design/vetro-clinico/07-piattaforme/web.md) | Guida web (implementazione di riferimento): mappa superficie->classe, lavori di consolidamento, budget di prestazione visiva. | Quando si implementa o rivede UI in app/ o components/. |
| [docs/design/vetro-clinico/07-piattaforme/apple.md](./design/vetro-clinico/07-piattaforme/apple.md) | Guida Apple: mappa HIG/Liquid Glass -> API SwiftUI, consolidamento VetroClinico.swift, idiomi per macOS/iPadOS/iOS. | Quando si lavora sulla UI nativa Apple o si rivede la parity di design. |
| [docs/design/vetro-clinico/07-piattaforme/windows.md](./design/vetro-clinico/07-piattaforme/windows.md) | Guida Windows previsionale (lane tri-OS): mapping su Fluent 2 (Mica/Acrylic), tipografia, confine shell nativa/canvas web. | Quando si progetta o pianifica il client Windows. |
...
| [docs/adr/0077-vetro-clinico-canonical-cross-platform-design-language.md](./adr/0077-vetro-clinico-canonical-cross-platform-design-language.md) | Propone Vetro Clinico come linguaggio di design canonico multipiattaforma: grammatica e token condivisi, materiali e interazioni idiomatici, accessibilità come contratto. |

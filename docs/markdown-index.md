...
| [docs/siss-sgdt-pai-feasibility.md](./siss-sgdt-pai-feasibility.md) | Nota canonica su SGDT/PAI per MMG/SSI: restringe SGDT al caso PAI/CE-MMG documentato e separa quel perimetro da launcher generici o feed PAI non dimostrati. | Quando si valuta SGDT oltre il boundary SISS/FSE attuale. |

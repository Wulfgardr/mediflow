...
| [docs/design/vetro-clinico/README.md](./design/vetro-clinico/README.md) | Ingresso della baseline storica e transitoria Vetro Clinico: glossario, ordine di lettura, regole redazionali e precedenza. | Quando serve capire lo stato storico/transitorio prima di un lavoro visivo o di interazione. |
...
| [docs/adr/0078-lume-lingua-di-design-di-destinazione.md](./adr/0078-lume-lingua-di-design-di-destinazione.md) | Adotta Lume come lingua di design di destinazione multipiattaforma (modello focale, filo, due voci), con Vetro Clinico come canone transitorio e migrazione L0-L6; ADR 0047 invariato. Status Proposed fino al merge del branch. |
| [docs/adr/0079-local-open-loops-and-result-link.md](./adr/0079-local-open-loops-and-result-link.md) | Propone le attese locali deterministiche: collegamento manuale osservazione-item, soglie temporali dichiarate, provenance nella Scheda e nessuna estensione paired. |

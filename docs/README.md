...
| Piano engineering a breve termine | [PLANS.md](../PLANS.md) | `CANONICAL` | 2-6 settimane, operativo. Dopo il rilascio `v0.5.0` governa stabilizzazione sul campo, patch `0.5.x` e discovery del nodo locale home-base. |

...
| Isolamento Intelligent Host, AIP e MCP | [docs/adr/0114-intelligent-host-aip-mcp-isolation.md](./adr/0114-intelligent-host-aip-mcp-isolation.md) | `CANONICAL / ACCEPTED` | Isola MCP `stdio` modern-only dal processo Web e riserva authority, lease e revoca a un broker AIP locale; la prima slice espone un solo tool di stato non-PHI. |

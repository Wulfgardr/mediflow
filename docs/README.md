...
| Contratto Intelligence Fabric | [docs/adr/0089-contratto-intelligence-fabric-e-venue-esecutive.md](./adr/0089-contratto-intelligence-fabric-e-venue-esecutive.md) | `CANONICAL / ACCEPTED` | Definisce capability, venue, profili egress, binding OCR espliciti, policy, ricevute e provenienza fail-closed. |
...
| Locator OCR e currentness della sorgente documentale | [docs/adr/0099-ocr-document-locator-and-source-currentness.md](./adr/0099-ocr-document-locator-and-source-currentness.md) | `CANONICAL / ACCEPTED` | Accetta O4: `documentSourceRef`, revision ed epoch monotoni, locator OCR host-owned monouso e revalidation pre/post async nel DAG O1-O5, senza autorizzare runtime o apply. |
...
| ADR router PDF deterministico per pagina | [docs/adr/0088-deterministic-pdf-page-router.md](./adr/0088-deterministic-pdf-page-router.md) | `CANONICAL` | Il binding nativo locale decide l'OCR pagina per pagina in un processo limitato; non sostituisce il provider OCR e non abilita scritture cliniche. |

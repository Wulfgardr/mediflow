...
- Registro proposto delle diagnosi documentali: [ADR 0087](./adr/0087-registro-proposte-diagnostiche-documentali.md)
...
| ADR registro delle proposte diagnostiche documentali | [docs/adr/0087-registro-proposte-diagnostiche-documentali.md](./adr/0087-registro-proposte-diagnostiche-documentali.md) | `CANONICAL / PROPOSED` | Propone un registro locale separato dalle diagnosi cliniche. Non aggiunge schema, migrazione, API, UI o runtime. |

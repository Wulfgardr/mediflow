...
| ADR Vetro Clinico multipiattaforma | [docs/adr/0077-vetro-clinico-canonical-cross-platform-design-language.md](./adr/0077-vetro-clinico-canonical-cross-platform-design-language.md) | `CANONICAL / ACCEPTED` | Adotta Vetro Clinico come grammatica e sistema di token condiviso, con materiali e interazioni adattati a web, Apple, Windows e Linux senza dichiarare parity applicativa non dimostrata. |

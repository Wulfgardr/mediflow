...
| FAQ pubbliche | [docs/FAQ.md](./FAQ.md) | `SECONDARY` | Sintesi rapida per capire cosa fa oggi MediFlow `v0.6.0`, quali sono i boundary dichiarati e come orientarsi nel progetto. |
...
| Process map prescrittivo SISS live | [docs/siss-prescription-live-process-map.md](./siss-prescription-live-process-map.md) | `SECONDARY` | Mappa public-safe del percorso osservato nella webapp prescrittiva: stati UI, catalogo specialistica, validazioni, registrazione e PDF senza identificativi reali o materiale di sessione. |

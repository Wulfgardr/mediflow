...
| Headless portabile agent-first e Fabric capability-first | [docs/adr/0117-headless-portable-agent-first-and-capability-first-fabric.md](./adr/0117-headless-portable-agent-first-and-capability-first-fabric.md) | `CANONICAL / ACCEPTED` | La 0.8.5 integra il Supervisor Node con Web standalone e MCP figli su IPC ereditato e il planner read-only. L’addendum 0.8.6 WUL-696 governa Mini come figlio per stato/catalogo. Non dichiara installer, onboarding o compatibilità con host MCP esterni. |

...
| Routing OCR selettivo DeepSeek-OCR 2 | [docs/adr/0111-deepseek-ocr2-selective-page-routing.md](./adr/0111-deepseek-ocr2-selective-page-routing.md) | `CANONICAL / ACCEPTED / OPTIONAL ADAPTER` | Usa `NeedsOcrError.pages/pageCount` come autorita e ammette al modello solo le pagine `needsOcr`; ADR 0117 rende il modello opzionale e governa la capability OCR model-agnostic. |
...
| Headless portabile agent-first e Fabric capability-first | [docs/adr/0117-headless-portable-agent-first-and-capability-first-fabric.md](./adr/0117-headless-portable-agent-first-and-capability-first-fabric.md) | `CANONICAL / ACCEPTED` | Richiede nella 0.8.5 un core Web/Headless Node 24 OS-agnostico, MCP/CLI realmente utili attraverso Application Services e binding Fabric per capability; DeepSeek-OCR 2/CUDA resta un adapter opzionale. |
...
| Estrazione locale unica degli allegati con AnyDoc | [docs/adr/0107-anydoc-local-attachment-extraction.md](./adr/0107-anydoc-local-attachment-extraction.md) | `CANONICAL / ACCEPTED` | Governa il primo passaggio deterministico locale. Il runtime osservato conserva `ocr=unavailable`; ADR 0117 richiede OCR soltanto per `needsOcr` e non rende obbligatorio alcun modello. |

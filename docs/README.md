...
| Scrittura SOAP Headless autorizzata dal medico | [docs/adr/0103-headless-clinician-authorized-soap-entry-write.md](./adr/0103-headless-clinician-authorized-soap-entry-write.md) | `CANONICAL / PROPOSED` | Propone un'eccezione unica, locale e monouso per append SOAP, senza runtime, apply generale o authority Fabric. |

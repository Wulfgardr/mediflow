...
| Locator OCR e currentness della sorgente documentale | [docs/adr/0099-ocr-document-locator-and-source-currentness.md](./adr/0099-ocr-document-locator-and-source-currentness.md) | `CANONICAL / PROPOSED` | Propone `documentSourceRef`, revision ed epoch monotoni, locator OCR volatile monouso e DAG O1-O5 senza autorizzare runtime o apply. |

...
- Limite digest-bound della readiness AI locale: [ADR 0088](./adr/0088-limite-digest-bound-readiness-ai-locale.md)
...
| Limite digest-bound della readiness AI locale | [docs/adr/0088-limite-digest-bound-readiness-ai-locale.md](./adr/0088-limite-digest-bound-readiness-ai-locale.md) | `CANONICAL / ACCEPTED` | Mantiene bloccata la qualified readiness e classifica il bracket come detection best-effort. |
...
| ADR limite digest-bound della readiness AI locale | [docs/adr/0088-limite-digest-bound-readiness-ai-locale.md](./adr/0088-limite-digest-bound-readiness-ai-locale.md) | `CANONICAL / ACCEPTED` | Definisce un'annotazione di readiness distinta dallo stato `runtime`; il bracket resta detection best-effort. |

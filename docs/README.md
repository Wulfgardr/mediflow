...
| ADR backup notturno via `launchd` | [docs/adr/0021-nightly-backup-via-macos-launchd.md](./adr/0021-nightly-backup-via-macos-launchd.md) | `CANONICAL` | Thin slice `WUL-30`: schedulazione notturna macOS via LaunchAgent utente e runner headless locale. |
| ADR retention backup keep-last-N | [docs/adr/0022-backup-retention-policy-keep-last-n.md](./adr/0022-backup-retention-policy-keep-last-n.md) | `CANONICAL` | Thin slice `WUL-31`: retention automatica limitata ai backup scheduler-owned con preview dry-run e cleanup tracciato. |

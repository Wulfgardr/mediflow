...
| SGDT/PAI per MMG/SSI | [docs/siss-sgdt-pai-feasibility.md](./siss-sgdt-pai-feasibility.md) | `CANONICAL` | Nota scenario-specific che restringe SGDT al caso PAI/CE-MMG documentato, distinguendolo da un launcher generico o da un feed PAI non dimostrato. |

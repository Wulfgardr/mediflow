...
### 4. Contratto Mini consumato dalla matrice mobile

Il gate `WUL-557` usa `packages/mini/contracts/mini-parity.json`, verificato
byte-identico nei head `3fd988bafe71a058fdd7d3c25ea569793dcba903`
(PR #184) e `1e35733c0218eae67a1d6e158085aab7340bc26b` (PR #190). Il
contratto dichiara 4 righe `available` su 66 (`6.060606%`); conteggi, ragioni e
crosswalk puntuale sono registrati nella matrice di parity.

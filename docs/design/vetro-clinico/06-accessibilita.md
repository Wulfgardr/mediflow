...
Due segnali indipendenti sono raggiungibili sul web: Reduce Motion come attributo e preferenza di sistema, Increase Contrast come media query. Le regole CSS per Reduce Transparency esistono, ma il provider web oggi forza il relativo attributo a `false`: il controllo resta un debito esplicito.

| Segnale | Resa |
| --- | --- |
| Reduce Transparency | Vetro quasi solido, blur 0 (vedi [03-materiali.md](./03-materiali.md)); resa CSS presente ma controllo web non ancora raggiungibile. |

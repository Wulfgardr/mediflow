...
| `signal.warning` | `#875b26` | derivato, non `rgb()` a mano | Attenzione clinica |
...
| `material.vitreous` | 14px | 1.02 | Pannelli strutturali: sidebar, header |
...
2. **Superfici card sui token**: sostituire `border-slate-200/70 bg-white/80` con `--paper-*` dove la superficie è carta clinica, non vetro.

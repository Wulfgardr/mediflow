...
6. **Una grammatica, materiali idiomatici.** I token semantici (colore, tipografia, spaziatura, geometria) sono unici a monte. Il materiale che li rende (Liquid Glass su Apple, vetro web, Mica/Acrylic su Windows, flat su GNOME) lo decide la piattaforma, mai il token.
...
| Direzione visiva unica su tutte le piattaforme: Vetro Clinico | [ADR 0077](../../adr/0077-vetro-clinico-canonical-cross-platform-design-language.md) | Niente temi concorrenti; grammatica e token restano condivisi, mentre materiali e interazioni si adattano alla piattaforma. |

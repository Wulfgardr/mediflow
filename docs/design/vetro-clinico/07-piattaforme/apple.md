...
3. **Spacchettare `PairedPatientsWorkspaceView`** (1813 righe) in viste per dominio (lista, quadro paziente, diario, terapie, osservazioni): prerequisito per qualsiasi lavoro di design fine.

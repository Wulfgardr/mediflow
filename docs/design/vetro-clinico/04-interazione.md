...
- **Inventario storico**: i 23 `confirm()`, 47 `alert()` e 1 `prompt()` nativi censiti dalla revisione 2026-07-02 sono il punto di partenza storico, non il backlog corrente; le chiamate di fallback dei provider restano intenzionali.

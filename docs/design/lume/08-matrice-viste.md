...
- La matrice usa `fedele` per Worklist e carico pazienti, Quadro paziente,
  Diario globale e Lock e sicurezza, sulla base della struttura osservata e
  degli smoke disponibili. In nessuno dei quattro casi lo stato sostituisce
  una prova visuale manuale Giorno e Grafite su display reale.

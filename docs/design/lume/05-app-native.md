...
- Parità dei contratti: le primitive LumeKit espongono gli stessi `accessibilityIdentifier` già usati dai test UI, così la migrazione non rompe l'automazione.

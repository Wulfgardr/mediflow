...
- [ADR 0034](./0034-local-only-default-and-network-home-base-opt-in.md)
  ...
  server-first.
- [ADR 0037](./0037-network-ai-plane-optional-central-runtime-on-trusted-lan.md)
...
- [docs/ROADMAP.md](../ROADMAP.md) e [PLANS.md](../../PLANS.md) indicano come
...
- La parity target della wave Apple e:
  - **macOS**: parity piena con il prodotto, inclusa l'orchestrazione AI locale
...
- L'AI plane resta separato:
  - l'esecuzione AI locale e orchestrata dal Mac `home-base`
...
1. `WUL-188`: persistire questa ADR e riallineare
   [PLANS.md](../../PLANS.md), [docs/ROADMAP.md](../ROADMAP.md),

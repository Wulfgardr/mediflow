...
- `PLANS.md` identifica T02 come stream attivo per strategia OpenAPI, baseline spec
  e contract checks.
...
- Una deprecazione in `v1` deve essere prima marcata nella spec e pianificata in
  `PLANS.md`/Linear; la rimozione avviene solo con major successiva o finestra di

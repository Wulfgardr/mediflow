...
- [ADR 0040](./0040-document-intelligence-evidence-ledger-and-decision-layers.md) fissa come north star la separazione tra `recognition`, `source governance`, `decision` e `render/projection`.

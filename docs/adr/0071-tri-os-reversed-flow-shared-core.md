...
ARCHITETTURA.md (private),
[docs/NATIVE.md](../NATIVE.md),
lib/security.ts (private),
[lib/db.ts](../../lib/db.ts),
native/MediFlowMac/Sources/MediFlowAppleShared/CryptoService.swift (private)
...
implementazioni byte-compatibili: web (WebCrypto, lib/security.ts (private))
...
- Zero-knowledge field crypto byte-exact ([[apple-paired-crypto]], lib/security.ts (private)):

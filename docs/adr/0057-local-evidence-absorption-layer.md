...
- Il protocollo Codex/Opus ammette Claude/Opus solo come reviewer design-time,
...
- [Document Intelligence Lab](../document-intelligence-lab.md)
- [Patient Insight benchmark](../patient-insight-benchmark.md)
- [Patient Insight document troubleshooting](../patient-insight-document-troubleshooting.md)
- [Codex / Opus Dialogue Protocol](../codex-opus-dialogue.md)

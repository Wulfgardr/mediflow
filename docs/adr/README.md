...
- [0087-registro-proposte-diagnostiche-documentali.md](./0087-registro-proposte-diagnostiche-documentali.md): propone un registro locale separato dalle diagnosi cliniche, senza aggiungere runtime.

...
- [0094-intelligence-fabric-headless-contract-085.md](./0094-intelligence-fabric-headless-contract-085.md): propone il contratto 0.8.5 tra Fabric host-owned, AIP broker-authorized e Mini, con apply negato e stack sostitutivo da `main`.

...
- [0099-ocr-document-locator-and-source-currentness.md](./0099-ocr-document-locator-and-source-currentness.md): accetta il contratto O4 fail-closed per locator OCR host-owned monouso, currentness e revalidation prima e dopo i confini asincroni.

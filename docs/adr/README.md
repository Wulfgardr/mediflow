...
- [0111-deepseek-ocr2-selective-page-routing.md](./0111-deepseek-ocr2-selective-page-routing.md): accetta il routing PDF selettivo con `NeedsOcrError.pages/pageCount`, materializzazione deterministica e DeepSeek-OCR 2 locale pin-by-digest; il runtime CUDA resta non qualificato sull'host Apple corrente.

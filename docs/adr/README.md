...
- [0107-anydoc-local-attachment-extraction.md](./0107-anydoc-local-attachment-extraction.md): accetta AnyDoc come unica corsia automatica locale per gli allegati; `ocr` resta classificata ma terminalmente `unavailable`, senza DeepSeek/Ollama, Apple Vision o fallback.

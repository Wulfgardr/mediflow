...
- [0088-limite-digest-bound-readiness-ai-locale.md](./0088-limite-digest-bound-readiness-ai-locale.md): accetta un'annotazione distinta da `runtime`; il bracket resta detection best-effort.

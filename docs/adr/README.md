...
- [0110-riapertura-governata-programma-intelligente-085.md](./0110-riapertura-governata-programma-intelligente-085.md): propone di riaprire in modo governato la 0.8.5 a DeepSeek-OCR 2 selettivo, provider OpenAI/Anthropic ufficiali, MCP/intelligent host, operazioni agentiche, recording e planner semantico; conserva i boundary local-first e impone packet, gate e claim separati.

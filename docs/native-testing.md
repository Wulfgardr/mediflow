...
4. Smoke mobile paired (quando tocchi `home-base` iPhone/iPad):
   ...
   - per modifiche al boundary `/api/v1/network/*`, esegui anche `npm run test:network:home-base-readonly` e `npm run test:network:home-base-write`

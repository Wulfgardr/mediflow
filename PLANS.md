...
- `WUL-192` e in corso come slice esplicitamente progressiva: il bundle macOS mostra il shell Apple/home-base, il readiness runtime locale e puo gestire esplicitamente backend web production e proxy TLS; Ollama/Docker-ICD sono visibili solo come diagnostica read-only, quindi non si dichiara ancora "no terminal" completo finche recovery/backoff e packaging firmabile non sono chiusi.

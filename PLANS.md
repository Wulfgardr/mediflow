...
- `WUL-192` e in corso come slice esplicitamente progressiva: il bundle macOS mostra il shell Apple/home-base, il readiness runtime locale e puo gestire esplicitamente backend web production e proxy TLS; non si dichiara ancora "no terminal" completo finche Ollama/Docker, recovery/backoff e packaging firmabile non hanno policy app-managed.

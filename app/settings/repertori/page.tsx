    ...
    return (
        <section className="space-y-4" data-testid="settings-repertori-section">
            ...
            <div className="grid grid-cols-1 items-start gap-6 xl:grid-cols-2">
                <div className={SETTINGS_CARD_CLASS} style={AIFA_PANEL_STYLE}>
                    ...
                    <div className="space-y-4">
                        ...
                        {drugCatalog?.manifest ? (
                            <div className={`rounded-[var(--lume-radius-control)] border p-4 text-sm leading-6 ${semanticSignalSurfaceClass('success')}`} style={{ color: 'var(--lume-ink)' }}>
                                <p className="font-semibold">Catalogo aggiornato</p>
                                <p className="mt-1 break-words">
                                    Scaricato il {drugCatalog.manifest.downloadedAt} · {drugCatalog.manifest.rowCount.toLocaleString('it-IT')} confezioni
                                </p>
                                <p className="mt-1 break-words">Fonte: <a className="underline [overflow-wrap:anywhere]" href={AIFA_CATALOG_DEFAULT_SOURCE_URL} target="_blank" rel="noopener noreferrer">AIFA Open Data</a></p>

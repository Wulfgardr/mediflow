...
/* @Codex */
/* WUL-271 Kree8-inspired full-surface MediFlow mockup, v2 pass.
   The route is isolated at /mockups/kree8 through RootRuntimeShell and has no
   global UI selector. All data is synthetic; no PHI; no remote assets; no new
   npm dependencies. */
...
import styles from './kree8-mockup.module.css';
...
export default function Kree8MockupPage() {
  const [area, setArea] = useState<AreaId>('turno');
  const [filter, setFilter] = useState<StatusFilter>('all');

  return (
    <div className={styles.shell} aria-label="MediFlow · Kree8 mockup WUL-271">
      <aside className={styles.rail}>
        ...
        <div className={styles.railFooter}>
          ...
          <span>Mockup WUL-271 · solo design</span>
        </div>
      </aside>
      ...
      <Link href="/" className={styles.exit} aria-label="Torna alla shell MediFlow runtime">
        <X size={12} />
        Esci dal mockup
      </Link>
    </div>

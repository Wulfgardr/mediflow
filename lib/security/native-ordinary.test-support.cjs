...
Module._resolveFilename = function(request, parent, ...args) {
    if (request === '@mediflow/web-auth-lifecycle-owner' && process.env.MEDIFLOW_SCOPED_SOURCE_OWNER === '1')
        return path.join(root, 'packages/web-auth-lifecycle-owner/index.js');

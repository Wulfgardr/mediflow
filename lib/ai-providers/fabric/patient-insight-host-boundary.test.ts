...
test('rejects free prompt, identity, patient, extra-key, accessor, and prototype inputs', () => {
    ...
    let accessorReads = 0; const accessor = request(); Object.defineProperty(accessor.projection, 'clinicalFocus', { enumerable: true, get() { accessorReads += 1; throw new Error('synthetic accessor'); } });

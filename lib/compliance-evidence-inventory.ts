    ...
    records: Object.freeze([
        ...
        evidenceRecord({
            ...
            evidence: [
                ...
                'lib/fhir/bundle-mapper.test.ts',
                'lib/report-service.test.ts',
                'docs/analysis/2026-09-06-086-regulatory-evidence.md',
                'docs/COMPLIANCE.md',
                'SECURITY.md',
            ],
            limitation: 'FHIR v0 e PDF esportano sottoinsiemi dei dati. Backup già esportati, tempi, identità del richiedente e completezza della risposta richiedono procedure organizzative separate.',
        ...
        evidenceRecord({
            ...
            summary: 'Fonti ufficiali consultate il 06/09/2026; le date dei testi sono indicate nei riferimenti. La valutazione resta legata al deployment e al caso concreto.',
            status: 'external_assessment_required',
            evidence: ['docs/COMPLIANCE.md', 'docs/analysis/2026-09-06-086-regulatory-evidence.md'],
            ...
            externalReferences: [
                {
                    label: 'GDPR, artt. 25 e 32 (consolidato 04/05/2016, rettifica 23/05/2018)',
                    href: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02016R0679-20160504',
                },
                {
                    label: 'AI Act (consolidato 27/07/2026)',
                    href: 'https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:02024R1689-20260727',
                },
                {
                    label: 'Commissione europea: AI Act (pagina aggiornata 03/08/2026)',

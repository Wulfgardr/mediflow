...
OUT_DIR="$ROOT_DIR/tmp-visit-transcript-draft-test"
...
npx tsc -p "$ROOT_DIR/tsconfig.visit-transcript-draft-test.json"
node --test "$OUT_DIR/visit-transcript-draft.test.js"

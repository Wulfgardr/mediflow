...
export const CONTRACT = [
    ...
    record('lib/backup-restore-executor.ts', 'restore-clear-binding', 'd4ccf892a10c8526', 1),
    ...
    record('lib/backup-restore-executor.ts', 'restore-table-binding', '6b416409aea79c35', 1),

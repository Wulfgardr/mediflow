...
export const CONTRACT = [
    ...
    record('components/document-upload.tsx', 'facade-update', '0ff837037f51a8f7', 1, 'delegated'),
    record('components/document-upload.tsx', 'facade-update', '447ea8fb738c3800', 1, 'delegated'),
    ...
    record('lib/backup-restore-executor.ts', 'restore-delete', 'd6e78eeab45f3a72', 1),
    record('lib/backup-restore-executor.ts', 'restore-insert-binding', '7a80ad9666be8ea3', 1),
    record('lib/backup-restore-executor.ts', 'restore-insert', 'e9d1fc20c04fbedd', 1),
    record('lib/backup-restore-executor.ts', 'restore-table-binding', 'ce6771a2ceb36fb1', 1),
    ...
    record('scripts/document-evidence-backfill-live-db.ts', 'raw-update', 'e2b01f457d7d8b56', 1, 'finding', 'LIVE_EVIDENCE_BACKFILL_CURRENTNESS_GAP'),

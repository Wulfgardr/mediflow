...
OUT_DIR="$ROOT_DIR/tmp-latest-request-guard-test"
...
npx tsc -p "$ROOT_DIR/tsconfig.latest-request-guard-test.json"
node --test "$OUT_DIR/latest-request-guard.test.js"

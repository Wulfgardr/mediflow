...
OUT_DIR="$ROOT_DIR/tmp-document-ocr-decision-test"
...
npx tsc -p "$ROOT_DIR/tsconfig.document-ocr-decision-test.json"
node --test "$OUT_DIR/document-ocr-decision.test.js"

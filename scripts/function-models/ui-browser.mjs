...
try {
 ...
 await picker.getByRole('button',{name:'Rileggi modelli'}).click();await picker.getByRole('button',{name:'Conferma il default attuale'}).waitFor();assert.equal(await picker.getByRole('button',{name:'Genera fixture'}).isDisabled(),true);await picker.getByRole('button',{name:'Conferma il default attuale'}).click();assert.equal(await picker.getByRole('button',{name:'Genera fixture'}).isDisabled(),false);
